...
public class UserInterfaceTui {
    ...
    private void callPalavrasService(Scanner scanner) {
        scanner.nextLine();
        System.out.println("Informe o texto para gerar as estatisticas:");
        String texto = scanner.nextLine();

        // Envia o texto digitado ao servidor pelo stub RPC.
        PalavrasService palavrasService = new PalavrasService();
        var result = palavrasService.ObterEstatistica(texto);
